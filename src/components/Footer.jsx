...
const Footer = () => {
  ...
  return (
    <div id='contact' className='w-full flex flex-col justify-center items-center'>
      {/* 1st box starts here */}
      <div data-aos="zoom-in" dat-aos-delay="100" className='w-full bg-themepurple lg:px-20 px-10 py-8 grid lg:grid-cols-6 grid-cols-2 justify-center items-center gap-10'>
      ...
      <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[auto,auto,auto,auto,auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10'>
        <div data-aos="zoom-in" dat-aos-delay="200" className='flex flex-col justify-center items-start gap-10'>
          <div className='flex flex-col justify-center items-start gap-4'>
        <h1 className='text-4xl font-bold text-themepurple underline italic'>Trendify</h1>
          <p className='text-gray-500 hover:text-themepurple text-justify'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.br Incidunt sed <br /> velit laborum iste iusto <br />ipsam placeat repellat aspernatur iure earum.</p>
          </div>
          <div className='flex flex-col justify-center items-start gap-4'>
        ...
        <div data-aos="zoom-in" dat-aos-delay="200">
      ...
      <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100'>
        ...
        <div className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-4 gap-10 flex-grow '>
          ...
          <div className='lg:w-[60%] w-full flex lg:flex-row flex-col justify-center items-center gap-4 flex-grow'>
            ...
            <div>
              <input type="email" placeholder='Enter valid email' className='lg:w-auto w-full capitalize rounded-l-lg py-3 px-6'/>
          ...
          <div className='lg:w-[20%] w-full '>
            <p className='text-gray-500 lg:text-end text-center'>2024 Powered SJCodingHub</p>
          </div>
        </div>
       ...
       <div id='icon-box' className='bg-themepurple text-white p-3 rounded-full hover:text-black curser-pointer fixed lg:bottom-6 right-6 bottom-6'>
